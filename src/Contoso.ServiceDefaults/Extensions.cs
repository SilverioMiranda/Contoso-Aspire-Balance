...
public static class Extensions
{
    ...
    public static IHostApplicationBuilder AddDefaultHealthChecks2(this IHostApplicationBuilder builder)
    {
    ...
    public static IHostApplicationBuilder AddApiKeyAuthentication(this IHostApplicationBuilder builder)
    {
